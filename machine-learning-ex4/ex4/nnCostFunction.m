...
%DELTA_1 = zeros(hidden_layer_size, input_layer_size );
%DELTA_2 = zeros(num_labels, hidden_layer_size );
...
%         computed in ex4.m
            ...
            for i = 1:m
            J = J + sum(sum(log(1-h(i,1:y(i)-1)))) + sum(sum(log(1-h(i,y(i)+1:end)))) + log(h(i,y(i))) ;  
            end
